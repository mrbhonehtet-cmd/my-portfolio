...
<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
  ...
  <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg card-hover">
    ...
    <div className="p-6">
      <h3 className="text-xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Ai Chatbot</h3>
  ...
  <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg card-hover">
    ...
    <div className="p-6">
      <h3 className="text-xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Food Donation Matching System</h3>
      <p className="text-gray-300 mb-4">
  ...
  <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg card-hover">
    ...
    <div className="p-6">
      <h3 className="text-xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Game Leaderboard Ranking Dashboard</h3>
      <p className="text-gray-300 mb-4">
  ...
  <div className="bg-gray-800 rounded-xl overflow-hidden shadow-lg card-hover">
    ...
    <div className="p-6">
      <h3 className="text-xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-500">Multi-Notepad Cloud Platform</h3>
      <p className="text-gray-300 mb-4">
